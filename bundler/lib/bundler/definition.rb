...
module Bundler
  class Definition
    ...
    def initialize(lockfile, dependencies, sources, unlock, ruby_version = nil, optional_groups = [], gemfiles = [])
      ...
      @separate_gem_lockfile_sections = @locked_gem_sources.none? {|s| s.remotes.size > 1 }

      unless @separate_gem_lockfile_sections
        msg = "Your lockfile contains a single rubygems source section with multiple remotes, which is insecure. You should regenerate your lockfile."

        Bundler::SharedHelpers.major_deprecation 2, msg

        @sources.separate_gem_lockfile_sections!
        @locked_gem_sources.each(&:separate_lockfile_sections!)
      end
    ...
    def converge_rubygems_sources
      return false if separate_gem_lockfile_sections?
